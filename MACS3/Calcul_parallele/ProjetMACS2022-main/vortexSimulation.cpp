...
int main( int nargs, char* argv[] )
{
    ...
    if(rank == 0)
    {
        ...
        // on recoit le seul truc qui à changer i.e m_velocity (private)
        
        // on le met a jour dans le grid de base puis opopop
        ...
        // affichage des points, on va aussi faire ca sur processeur de rank 1
