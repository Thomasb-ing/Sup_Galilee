...
//// Init
////
void init( int* Ndim_tab, int nfic, double* temp0, double* kdiff, double* x , double* y, double* dx )
{
  const double lx = 5.;
  const double ly = 1;
...
int main( int nargc, char* argv[])
{
  ...
  double *x,*y, *temp1, *temp0,  *bilan, *kdiff;
  ...
  init(  Ndim_tab, nfic,  temp0, kdiff, x, y, dx);
